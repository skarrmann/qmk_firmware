...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [DEF] = LAYOUT_skarrmann(
    ...
    SYM_TAB, KC_A   , KC_R   , KC_S   , KC_T   , KC_D   ,                   KC_H   , KC_N   , KC_E   , KC_I   , KC_O   , SFT_QUO,
    KC_LGUI, KC_Z   , KC_X   , KC_C   , KC_V   , KC_B   ,                   KC_K   , KC_M   , KC_COMM, KC_DOT , KC_SLSH, KC_RGUI,
                                        CTL_DEL, KC_LSFT, KC_ESC , KC_ENT , FUN_SPC, CTL_BSP
  ),
  ...
  [FUN] = LAYOUT_skarrmann(
    _______, KC_F1  , KC_F2  , KC_F3  , KC_F4  , KC_PSCR,                   _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END , _______,
  ...
  [GAM] = LAYOUT_skarrmann(
    ...
    _______, _______, _______, _______, _______, _______,                   _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______,                   _______, _______, _______, _______, _______, _______,
                                        _______, KC_SPC , _______, _______, KC_TAB , _______
  ),
};
