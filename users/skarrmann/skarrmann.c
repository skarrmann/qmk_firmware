...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [DEF] = LAYOUT_skarrmann(
        ...
        KC_LALT, KC_LGUI, TO_DEF , KC_ESC , KC_DEL , KC_LSFT, KC_ESC , KC_ENT , SYM_SPC, KC_BSPC, KC_ENT , TG_GAM , KC_RGUI, KC_RALT
    ),

    [SYM] = LAYOUT_skarrmann(
        KC_TILD, KC_1   , KC_2   , KC_3   , KC_4   , KC_5   ,                   KC_6   , KC_7   , KC_8   , KC_9   , KC_COLN, KC_UNDS,
        KC_HASH, KC_EXLM, KC_LPRN, KC_RPRN, KC_DLR , KC_AMPR,                   KC_PIPE, KC_EQL , KC_LCBR, KC_RCBR, KC_0   , KC_DQUO,
        _______, KC_AT  , KC_LBRC, KC_RBRC, KC_PLUS, KC_PERC, _______, _______, KC_CIRC, KC_ASTR, KC_LABK, KC_RABK, KC_QUES, KC_BSLS,
    ...
    [GAM] = LAYOUT_skarrmann(
        ...
        _______, _______, _______, _______, _______, _______,                   _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, KC_SPC , _______, KC_LEFT, KC_DOWN, KC_UP  , KC_RGHT
    ),
