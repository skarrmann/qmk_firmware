...
/* Base modifiers - for productivity and efficiency
 ...
 |--------+--------+--------+--------+--------+--------| |--------+--------+--------+--------+--------+--------|
 |        |        |  (KC)  |  (KC)  |  (KC)  |        | |        |  (KC)  |  (KC)  |  (KC)  |        |   '    |
 |  LSFT  |        |  LGUI  |  LALT  |  LCTL  |        | |        |  RCTL  |  RALT  |  RGUI  |        |  RSFT  |
 |--------+--------+--------+--------+--------+--------| |--------+--------+--------+--------+--------+--------|
 |  ESC   |        |        |        |        |        | |        |        |        |        |        |  ENT   |
 |  LCTL  |        |        |        |        |        | |        |        |        |        |        |  RCTL  |
 |--------+--------+--------+--------+--------+--------| |--------+--------+--------+--------+--------+--------|
...
#define B_LH_MODS(k1, k2, k3, k4) k1              , MT(MOD_LGUI, k2), MT(MOD_LALT, k3), MT(MOD_LCTL, k4)
#define B_RH_MODS(k1, k2, k3, k4) MT(MOD_RCTL, k1), MT(MOD_RALT, k2), MT(MOD_RGUI, k3), k4              
...
#define NAVIGATE_L2_________________________________________ _______, _______, KC_LGUI, KC_LALT, KC_LCTL, _______
...
#define FUNCTION_R2_________________________________________ COLEMAK, KC_RCTL, KC_RALT, KC_RGUI, _______, _______ 
#define FUNCTION_R3_________________________________________ TG_GAME, _______, _______, _______, _______, _______
...
#define GAME_L1_____________________________________________ _______, QWERTY_L1__________________________________
