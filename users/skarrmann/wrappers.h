...
<<<<<<< HEAD
 |  LCTL  |  LGUI  |  LALT  |        |  NAV   | LOWER  | | RAISE  |  FUNC  |        |        |        |        |
=======
 |  LCTL  |  LGUI  |  LALT  |        |FUNCTION| SYMBOL | | NUMBER |NAVIGATE|        |        |        |        |
>>>>>>> layer-consolidation
 `-----------------------------------------------------' `-----------------------------------------------------'
 */
#define B_L0 KC_GRV
...
/* NAV
 ...
 `-----------------------------------------------------' `-----------------------------------------------------'
 */
#define ______________________NAV_L0________________________ _______, _______, _______, _______, _______, _______
#define ______________________NAV_L1________________________ _______, _______, _______, _______, _______, _______
#define ______________________NAV_L2________________________ _______, _______, _______, _______, _______, _______
#define ______________________NAV_L3________________________ _______, _______, _______, _______, _______, _______
#define ______________________NAV_L4________________________ _______, _______, _______, _______, _______, _______

#define ______________________NAV_R0________________________ _______, _______, _______, _______, _______, _______
#define ______________________NAV_R1________________________ _______, KC_HOME, KC_PGUP, KC_PGDN, KC_END , _______
#define ______________________NAV_R2________________________ _______, KC_LEFT, KC_DOWN, KC_UP  , KC_RGHT, _______
#define ______________________NAV_R3________________________ _______, KC_INS , KC_CAPS, KC_SLCK, KC_NLCK, _______
#define ______________________NAV_R4________________________ _______, _______, _______, _______, _______, _______
...
/* FUNC
 ...
 `-----------------------------------------------------' `-----------------------------------------------------'
 */
#define ______________________FUNC_L0_______________________ _______, _______, _______, _______, _______, _______
#define ______________________FUNC_L1_______________________ _______, KC_F1  , KC_F2  , KC_F3  , KC_F4  , KC_PSCR
#define ______________________FUNC_L2_______________________ _______, KC_F5  , KC_F6  , KC_F7  , KC_F8  , KC_SLCK
#define ______________________FUNC_L3_______________________ _______, KC_F9  , KC_F10 , KC_F11 , KC_F12 , KC_PAUS
#define ______________________FUNC_L4_______________________ _______, _______, _______, _______, _______, _______

#define ______________________FUNC_R0_______________________ _______, _______, _______, _______, _______, _______
#define ______________________FUNC_R1_______________________ _______, _______, _______, _______, _______, _______
#define ______________________FUNC_R2_______________________ _______, _______, _______, _______, _______, _______
#define ______________________FUNC_R3_______________________ _______, _______, _______, _______, _______, _______
#define ______________________FUNC_R4_______________________ _______, _______, _______, _______, _______, _______
=======
/* Base layers */
...
#define SYMBOL_L1___________________________________________ _______, KC_GRV , KC_LBRC, KC_RBRC, KC_EQL , KC_SLSH
#define SYMBOL_L2___________________________________________ _______, KC_EXLM, KC_AT  , KC_HASH, KC_DLR , KC_PERC
#define SYMBOL_L3___________________________________________ _______, KC_TILD, KC_DOT , KC_COMM, KC_DQUO, KC_SCLN
...
#define SYMBOL_R1___________________________________________ KC_BSLS, KC_ASTR, KC_LCBR, KC_RCBR, KC_PLUS, _______
#define SYMBOL_R2___________________________________________ KC_CIRC, KC_AMPR, KC_LPRN, KC_RPRN, KC_PIPE, _______
#define SYMBOL_R3___________________________________________ KC_COLN, KC_UNDS, KC_LABK, KC_RABK, KC_QUES, _______
#define SYMBOL_R4___________________________________________ _______, _______, _______, _______, _______, _______

#define NUMBER_L0___________________________________________ _______, _______, _______, _______, _______, _______
#define NUMBER_L1___________________________________________ _______, _______, _______, _______, _______, _______
#define NUMBER_L2___________________________________________ _______, KC_1   , KC_2   , KC_3   , KC_4   , KC_5   
#define NUMBER_L3___________________________________________ _______, _______, _______, _______, _______, _______
#define NUMBER_L4___________________________________________ _______, _______, _______, _______, _______, _______

#define NUMBER_R0___________________________________________ _______, _______, _______, _______, _______, _______
#define NUMBER_R1___________________________________________ _______, _______, _______, _______, _______, _______
#define NUMBER_R2___________________________________________ KC_6   , KC_7   , KC_8   , KC_9   , KC_0   , _______
#define NUMBER_R3___________________________________________ _______, _______, _______, _______, _______, _______
#define NUMBER_R4___________________________________________ _______, _______, _______, _______, _______, _______
...
#define NAVIGATE_R1_________________________________________ _______, KC_HOME, KC_PGUP, KC_PGDN, KC_END , _______
