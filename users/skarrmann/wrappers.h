...
#define SYMBOL_L2___________________________________________ KC_HASH, KC_6   , KC_7   , KC_8   , KC_9   , KC_0   
#define SYMBOL_L3___________________________________________ KC_CIRC, KC_AT  , KC_LBRC, KC_RBRC, KC_PLUS, KC_PERC
...
#define SYMBOL_R1___________________________________________ KC_TILD, KC_DLR , KC_LCBR, KC_RCBR, KC_COLN, KC_UNDS
#define SYMBOL_R2___________________________________________ KC_PIPE, KC_EQL , KC_LPRN, KC_RPRN, KC_EXLM, KC_DQUO
#define SYMBOL_R3___________________________________________ KC_AMPR, KC_ASTR, KC_LABK, KC_RABK, KC_QUES, KC_BSLS
