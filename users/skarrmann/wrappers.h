...
/* Base modifiers - for productivity and efficiency
 ...
 |  LSFT  |  LGUI  |  LALT  |  LCTL  |  NAV   |        | |        |  FUNC  |  RCTL  |  RALT  |  RGUI  |  RSFT  |
 |--------+--------+--------+--------+--------+--------| |--------+--------+--------+--------+--------+--------|
 |  ESC   |        |        |        |        |        | |        |        |        |        |        |  ENT   |
 |  LCTL  |        |        |        |        |        | |        |        |        |        |        |  RCTL  |
 |--------+--------+--------+--------+--------+--------| |--------+--------+--------+--------+--------+--------|
 |        |        |        |  APP   |  DEL   |  TAB   | |  SPC   |  BSPC  |  LEFT  |  DOWN  |   UP   | RIGHT  |
 |  LCTL  |  LGUI  |  LALT  |        |  RAISE | LOWER  | | LOWER  | RAISE  |        |        |        |        |
 `-----------------------------------------------------' `-----------------------------------------------------'
 */
#define B_L0 KC_GRV
#define B_L1 KC_CAPS
...
#define B_LC(k) MT(MOD_LCTL, k)
#define B_LD(k) LT(_NAV, k)

#define B_RA(k) MT(MOD_RGUI, k)
#define B_RB(k) MT(MOD_RALT, k)
#define B_RC(k) MT(MOD_RCTL, k)
#define B_RD(k) LT(_FUNC, k)

#define B_B0 KC_LCTL
#define B_B1 KC_LGUI
#define B_B2 KC_LALT
#define B_B3 KC_APP
#define B_B4 LT(_RAISE, KC_DEL)
#define B_B5 LT(_LOWER, KC_TAB)
#define B_B6 LT(_LOWER, KC_SPC)
#define B_B7 LT(_RAISE, KC_BSPC)
#define B_B8 KC_LEFT
#define B_B9 KC_DOWN
#define B_BA KC_UP
