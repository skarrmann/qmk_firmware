...
/* Base modifiers - for productivity and efficiency
 ...
 |  LCTL  |  LGUI  |  LALT  |        | NUMBER | LOWER  | | RAISE  |        |        |        |        |        |
 `-----------------------------------------------------' `-----------------------------------------------------'
 */
#define B_L0 KC_GRV
#define B_L1 KC_CAPS
...
/* NUMBER
 ...
 `-----------------------------------------------------' `-----------------------------------------------------'
 */
#define _________________NUMBER_L1_________________ _______, KC_LBRC, KC_RBRC, KC_EQL , _______
#define _________________NUMBER_L2_________________ KC_1   , KC_2   , KC_3   , KC_4   , KC_5   
#define _________________NUMBER_L3_________________ _______, KC_LABK, KC_RABK, _______, _______

#define _________________NUMBER_R1_________________ _______, KC_ASTR, KC_LRPN, KC_RPRN, KC_PLUS
#define _________________NUMBER_R2_________________ KC_6   , KC_7   , KC_8   , KC_9   , KC_0   
#define _________________NUMBER_R3_________________ _______, _______, KC_COMM, KC_DOT , KC_SLSH
