...
#define SYMBOL_L1___________________________________________ _______, KC_1   , KC_2   , KC_3   , KC_4   , KC_5   
#define SYMBOL_L2___________________________________________ _______, KC_EXLM, KC_LCBR, KC_RCBR, KC_DLR , KC_PERC
#define SYMBOL_L3___________________________________________ _______, KC_AT  , KC_LBRC, KC_RBRC, KC_HASH, KC_GRV
...
#define SYMBOL_R1___________________________________________ KC_6   , KC_7   , KC_8   , KC_9   , KC_0   , _______
#define SYMBOL_R2___________________________________________ KC_CIRC, KC_AMPR, KC_LPRN, KC_RPRN, KC_PIPE, _______
#define SYMBOL_R3___________________________________________ KC_TILD, KC_ASTR, KC_LABK, KC_RABK, KC_BSLS, _______
