...
#define BASE1_T(k) LT(_HOME1, k)
#define BASE2_T(k) LT(_HOME2, k)
#define BASE3_T(k) LT(_HOME3, k)
#define BASE4_T(k) LT(_HOME4, k)
...
/* Layer Home1 (Mouse)
 ,-----------------------------------------------------. ,-----------------------------------------------------.
 |        |Ms-Acl0 |Ms-Acl1 |Ms-Acl2 |[][][][]|        | |        |        |        |        |        |        |
 |--------+--------+--------+--------+--------+--------| |--------+--------+--------+--------+--------+--------|
 |        |        |        |        |        |        | |        |Ms-WLeft|Ms-WDown| Ms-WUp |Ms-WRght|        |
 |--------+--------+--------+--------+--------+--------| |--------+--------+--------+--------+--------+--------|
 |        |        |        |        |        |        | |        |Ms-Left |Ms-Down | Ms-Up  |Ms-Right|        |
 |--------+--------+--------+--------+--------+--------| |--------+--------+--------+--------+--------+--------|
 |        |        |        |        |        |        | |        |Ms-Btn2 |Ms-Btn3 |Ms-Btn4 |Ms-Btn5 |        |
 |--------+--------+--------+--------+--------+--------| |--------+--------+--------+--------+--------+--------|
 |        |        |        |        |        |        | |Ms-Btn1 |        |        |        |        |        |
 `-----------------------------------------------------' `-----------------------------------------------------'
 */
#define _____________________HOME1_L0_______________________ _______, _______, _______, _______, _______, _______
#define _____________________HOME1_L1_______________________ _______, KC_ACL0, KC_ACL1, KC_ACL2, KC_TRNS, _______
#define _____________________HOME1_L2_______________________ _______, _______, _______, _______, _______, _______
#define _____________________HOME1_L3_______________________ _______, _______, _______, _______, _______, _______
...
#define _____________________HOME2_L2_______________________ _______, _______, _______, _______, KC_TRNS, _______
...
#define _____________________HOME3_L1_______________________ _______, KC_MPRV, KC_MSTP, KC_MPLY, KC_MNXT, _______
#define _____________________HOME3_L2_______________________ _______, KC_MUTE, KC_VOLD, KC_VOLU, _______, _______
#define _____________________HOME3_L3_______________________ _______, _______, _______, _______, _______, _______
...
#define _____________________HOME3_R1_______________________ _______, KC_TRNS, _______, _______, _______, _______
...
#define _____________________HOME4_L1_______________________ _______, KC_F1  , KC_2   , KC_3   , KC_4   , KC_PSCR
#define _____________________HOME4_L2_______________________ _______, KC_F5  , KC_6   , KC_7   , KC_8   , KC_SLCK
#define _____________________HOME4_L3_______________________ _______, KC_F9  , KC_F10 , KC_F11 , KC_F12 , KC_PAUS
...
#define _____________________HOME4_R2_______________________ _______, KC_TRNS, _______, _______, _______, _______
