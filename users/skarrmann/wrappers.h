...
#define GAME_L2_____________________________________________ KC_LSFT, _______, _______, _______, _______, _______
#define GAME_L3_____________________________________________ KC_LCTL, _______, _______, _______, _______, _______
#define GAME_L4_____________________________________________ _______, _______, _______, KC_ESC , KC_TAB , KC_SPC 
...
#define GAME_R2_____________________________________________ _______, _______, _______, _______, _______, KC_QUOT
#define GAME_R3_____________________________________________ _______, _______, _______, _______, _______, KC_ENT 
