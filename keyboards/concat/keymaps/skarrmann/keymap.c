...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = {
        LAYOUT_concat_wrapper( \
                 ...
                 B_L3   , QWERTY_L3__________________________________,          \
        KC_LGUI, KC_PGUP, KC_GRV , KC_LBRC, KC_RBRC, KC_LALT, KC_LSFT, KC_LCTL, \
        ...
        LAYOUT_concat_wrapper( \
                 ...
                 QWERTY_R3__________________________________, B_R3   ,          \
        KC_RCTL, KC_RSFT, KC_RALT, KC_EQL , KC_RBRC, KC_INS , KC_UP  , KC_RGUI, \
    ...
    [_COLEMAK] = {
        LAYOUT_concat_wrapper( \
                 ...
                 B_L3   , COLEMAK_L3_________________________________,          \
        KC_LGUI, KC_PGUP, KC_GRV , KC_LBRC, KC_RBRC, KC_LALT, KC_LSFT, KC_LCTL, \
        KC_HOME, KC_PGDN, KC_END ,                   B_B4   , B_B5   , KC_ESC),
        LAYOUT_concat_wrapper( \
                 COLEMAK_R1_________________________________, B_R1   ,          \
                 COLEMAK_R2_________________________________, B_R2   ,          \
                 COLEMAK_R3_________________________________, B_R3   ,          \
        KC_RCTL, KC_RSFT, KC_RALT, KC_EQL , KC_RBRC, KC_INS , KC_UP  , KC_RGUI, \
        KC_ENT , B_B6   , B_B7   ,                   KC_LEFT, KC_DOWN, KC_RGHT)
    },
    [_SYMBOL] = {
	LAYOUT_concat_wrapper( \
		 ...
		 SYMBOL_L3___________________________________________,          \
	...
	LAYOUT_concat_wrapper( \
		 ...
		 SYMBOL_R3___________________________________________,          \
        _______, _______, _______, _______, _______, _______, _______, _______, \
        _______, _______, _______,                   _______, _______, _______)
    },
    [_NAVIGATE] = {
	LAYOUT_concat_wrapper( \
		 ...
		 NAVIGATE_L3_________________________________________,          \
        _______, _______, _______, _______, _______, _______, _______, _______, \
        _______, _______, _______,                   _______, _______, _______),
	LAYOUT_concat_wrapper( \
		 NAVIGATE_R1_________________________________________,          \
		 NAVIGATE_R2_________________________________________,          \
		 NAVIGATE_R3_________________________________________,          \
        _______, _______, _______, _______, _______, _______, _______, _______, \
        _______, _______, _______,                   _______, _______, _______)
    },
    [_FUNCTION] = {
        LAYOUT_concat_wrapper( \
                 ...
                 FUNCTION_L3_________________________________________,          \
        _______, _______, _______, _______, _______, _______, _______, _______, \
        _______, _______, _______,                   _______, _______, _______),
        LAYOUT_concat_wrapper( \
                 FUNCTION_R1_________________________________________,          \
                 FUNCTION_R2_________________________________________,          \
                 FUNCTION_R3_________________________________________,          \
        _______, _______, _______, _______, _______, _______, _______, _______, \
        _______, _______, _______,                   _______, _______, _______)
    },
    [_GAME] = {
	LAYOUT_concat_wrapper( \
		 ...
		 GAME_L3_____________________________________________,          \
        _______, _______, _______, _______, _______, _______, _______, _______, \
	...
	LAYOUT_concat_wrapper( \
		 ...
		 GAME_R3_____________________________________________,          \
        _______, _______, _______, _______, _______, _______, _______, _______, \
