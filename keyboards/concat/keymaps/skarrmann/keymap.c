...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = {
        LAYOUT_concat_wrapper( \
                 ...
                 B_LO1  , QWERTY_L1__________________________________,          \
                 B_LO2  , QWERTY_L2__________________________________,          \
        _______, B_LO3  , QWERTY_L3__________________________________, B_LI3  , \
        _______, _______, _______,                   B_LB2  , B_LB1  , B_LI4),
        LAYOUT_concat_wrapper( \
                 NUMROW_R0__________________________________, _______,          \
                 QWERTY_R1__________________________________, B_RO1  ,          \
                 QWERTY_R2__________________________________, B_RO2  ,          \
        B_RI3  , QWERTY_R3__________________________________, B_RO3  , _______, \
        B_RI4  , B_RB1  , B_RB2  ,                   _______, _______, _______)
    },
    [_COLEMAK] = {
        LAYOUT_concat_wrapper( \
                 _______, NUMROW_L0__________________________________,          \
                 B_LO1  , COLEMAK_L1_________________________________,          \
                 B_LO2  , COLEMAK_L2_________________________________,          \
        _______, B_LO3  , COLEMAK_L3_________________________________, _______, \
        _______, _______, _______,                   B_LB2  , B_LB1  , B_LI4),
        LAYOUT_concat_wrapper( \
                 NUMROW_R0__________________________________, _______,          \
                 COLEMAK_R1_________________________________, B_RO1  ,          \
                 COLEMAK_R2_________________________________, B_RO2  ,          \
        B_RI3  , COLEMAK_R3_________________________________, B_RO3  , _______, \
        B_RI4  , B_RB1  , B_RB2  ,                   _______, _______, _______)
    },
    [_SYMBOL] = {
	LAYOUT_concat_wrapper( \
