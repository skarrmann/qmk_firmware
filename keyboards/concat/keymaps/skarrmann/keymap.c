...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	LAYOUT_concat_wrapper( \
		 ...
		 HMOD_L1_____________________________________________,          \
		 HMOD_L2_____________________________________________,          \
        _______, HMOD_L3_____________________________________________, _______, \
        _______, _______, _______,                   _______, _______, _______),
	LAYOUT_concat_wrapper( \
                 _______, _______, _______, _______, _______, _______,          \
		 HMOD_R1_____________________________________________,          \
		 HMOD_R2_____________________________________________,          \
	_______, HMOD_R3_____________________________________________, _______, \
        _______, _______, _______,                   _______, _______, _______)
    },
    [_SYMBOL] = {
	LAYOUT_concat_wrapper( \
