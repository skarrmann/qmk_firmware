...
LAYOUT_ortho_5x12_wrapper( \
  _______, NUMROW_L0__________________________________, NUMROW_R0__________________________________, _______, \
...
[_HMOD] = LAYOUT_ortho_5x12_wrapper( \
  HMOD_L0_____________________________________________, HMOD_R0_____________________________________________, \
  ...
  HMOD_L3_____________________________________________, HMOD_R3_____________________________________________, \
  HMOD_L4_____________________________________________, HMOD_R4_____________________________________________  \
),
